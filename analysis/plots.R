...
plot (lda ~ x, type="l", lty=2, lwd=2, xlab="URL Depth", ylab="Num unique known-event URLs", ylim=c(0,60), cex.lab=2)
lines (nmf ~ x, lty=1, lwd=2, col="red")
legend("topright", c("TMINMF", "LDA"), col = c("red", "black"), lwd=2, lty=c(1,2),bty="n", cex=2)
dev.off()
...
plot (lda ~ x, type="l", lty=2, lwd=2, xlab="URL Depth", ylab="Prop of true events", ylim=c(0,0.8), cex.lab=2)
lines (nmf ~ x, lty=1, lwd=2, col="red")
legend("topright", c("TMINMF", "LDA"), col = c("red", "black"), lwd=2, lty=c(1,2),bty="n", cex=2)
dev.off()
