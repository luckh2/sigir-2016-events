...
We calculate the topic time series ACF as described in the previous section. As in \cite{Weng2011}, we compare our event detection model to the baseline of LDA-generated topics ranked by topic time series ACF.  The top $N$ topic models are evaluated as described in the next section. 
